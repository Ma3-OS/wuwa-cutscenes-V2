...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate videos_info.json")
    parser.add_argument("--movies", default=Movies_path, help="Path to Movies folder")
    parser.add_argument("--txtp", default=WwiseAudio_Generated_txtp_path, help="Path to txtp folder")
    parser.add_argument("--locale", default=Locale_wanted, help="Locale wanted, e.g., zh, en")
    args = parser.parse_args()

    Movies_path = args.movies
    WwiseAudio_Generated_txtp_path = args.txtp
    Locale_wanted = args.locale

    videodata = load_json("videodata.json")
    videosound = load_json("videosound.json")

    print(f"INF: Generating videos_info.json with Locale={Locale_wanted}")
